#!/usr/bin/env python3
"""
Worthit Core - Token Usage and Cost Calculation

Shared logic for calculating Claude API token usage and costs
across all platforms (Linux, macOS, Windows).

This module is imported by platform-specific shell scripts.
"""
